        ...
        <div class="card mt-5">
            <div class="card-body position-relative">
               <div class="card-body position-relative">
                ...
                <h5 class="mb-0" style="color: #FFF02D">Commercial Invoice History</h5>
            </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ isset(config("invrule_types")[json_decode($item->detail)->invrule_type]) ? config("invrule_types")[json_decode($item->detail)->invrule_type] : json_decode($item->detail)->invrule_type }}</td>
                                <td>
