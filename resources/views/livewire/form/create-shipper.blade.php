<div>
    ...
    <form wire:submit.prevent='submit'>
        ...
        <div style="width: 100%; display: table;">
                ...
                <div style="width: 50%; display: table-cell;">
                    ...
                    <div class="col-sm-12 col-lg-11 mb-4">
                         <div class="card text-gray" style="background-color: #FFF02D">
                            <div class="card-body">
                                <div class="card-title">Info Shipper</div>
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label text-uppercase" for="shipper_name">Shipper Name</label>
                                        <input wire:model='shipper_name' class="form-control" id="shipper_name" type="text" placeholder="Shipper Name" />
                                        @error('shipper_name') <span class="error">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input wire:model='pic_phone' class="form-control" id="pic_phone" type="number" placeholder="PIC Phone" />
            ...
            <div class="mb-3">
                <a href="{{ route("master.shipper") }}" class="btn btn-secondary btn-sm" type="submit">< Return</a>
