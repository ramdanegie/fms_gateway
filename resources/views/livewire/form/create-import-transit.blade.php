<div>
    ...
    <form wire:submit.prevent='submit'>
        <div class="row">
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="destination">Destination</label>
            ...
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="vessel">Vessel</label>
        ...
        <div class="row">
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="voyage">Voyage</label>
            ...
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="stf_cls">STF/CLS</label>
        ...
        <div class="row">
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="etd_origin">ETD Origin</label>
            ...
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="eta_destination">ETA Destination</label>
        ...
        <div class="row">
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="ves_connecting">Ves Connecting</label>
            ...
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="voy_connecting">Voy Connecting</label>
        ...
        <div class="row">
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="city_connecting">Connecting City</label>
                    <input wire:model='city_connecting' class="form-control" id="city_connecting" type="text" placeholder="d/m/Y" data-options='{"enableTime":false,"dateFormat":"d/m/Y","disableMobile":true}' />
                    @error('city_connecting') <span class="error">{{ $message }}</span> @enderror
                </div>
            </div>
            <div class="col-6">
                <div class="mb-3">
                    <label class="form-label text-uppercase" for="etd_destination">ETD Destination</label>
        ...
        <div class="mb-3">
            <a href="{{ route("internal.master.import-transit") }}" class="btn btn-secondary btn-sm" type="submit">< Return</a>
