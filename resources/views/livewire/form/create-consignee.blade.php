<div>
    ...
    <form wire:submit.prevent='submit'>
        ...
        <div style="width: 100%; display: table;">
                ...
                <div style="width: 50%; display: table-cell;">
                    ...
                    <div class="col-sm-12 col-lg-11 mb-4">
                         <div class="card text-gray" style="background-color: #FFF02D">
                            <div class="card-body">
                                <div class="card-title">Info Consignee</div>
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label text-uppercase" for="consignee_name">Consignee Name</label>
                                        <input wire:model='consignee_name' class="form-control" id="consignee_name" type="text" placeholder="Consignee Name" />
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input wire:model='email' class="form-control" id="email" type="text" placeholder="Email" />
            ...
            <div class="mb-3">
                <a href="{{ route("master.consignee") }}" class="btn btn-secondary btn-sm" type="submit">< Return</a>
