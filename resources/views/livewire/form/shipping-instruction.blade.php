    ...
    <script>
        ...
        function jsChangeNotify(el) {
            ...
            var _this = $(el),
                    item = _this.find("option:selected").data("bind");
            console.log(item)
            $("#notifi_country").val(item.country).change();
            $("#notifi_city").val(item.city).change();
            $("#notifi_address").val(item.address).change();
            $("#notifi_picphone").val(item.pic_phone).change();
            $("#notifi_picname").val(item.pic_name).change();
            $("#notifi_email").val(item.email).change();
        }
        ...
        <form wire:submit.prevent='submit'>
            <div class="row g-2">
                <div class="card-header" style="background-color: #1E367B">
                    <h5 class="mb-0" style="color: #FFF02D">Detail Shipment</h5>
                </div>
                <div class="col-3">
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label" for="si_number">Your SI Number</label> <!-- Notes : Free Text -->
                                <input wire:model='si_number' class="form-control" id="si_number" type="text" />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-4">
                                    <div class="form-check form-switch">
                                        <input wire:model='chk_clearance' class="form-check-input" id="chk_clearance" type="checkbox"/>
                                        <label class="form-check-label" for="chk_clearance">
                                            @if ($trade_type == "EX") Handling PEB & NPE
                                            @elseif ($trade_type == "IM") Handling PIB
                                            @else Include Custom Clearance
                                            @endif
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="form-check form-switch">
                                        <input wire:model='chk_certificate' class="form-check-input" id="chk_certificate" type="checkbox" checked="" />
                                        <label class="form-check-label" for="chk_certificate">Request Certificate of Origin</label>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="col-4">
                                    <div class="form-check form-switch">
                                        <input {{ empty($chk_pickup) ? "disabled" : "" }} wire:model='chk_pickup' class="form-check-input" id="chk_pickup" type="checkbox" checked="" />
                                            <label class="form-check-label" for="chk_pickup">Include Pickup Service</label>
                                    </div>
                                </div>
                                @elseif($trade_type == "IM")
                                <div class="col-4">
                                    <div class="form-check form-switch">
                                        <input wire:model='chk_delivery' class="form-check-input" id="chk_delivery" type="checkbox" checked="" />
                                        <label class="form-check-label" for="chk_delivery">Include Delivery Service</label>
                                    </div>
                                </div>
                                @endif
                                @endif
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <select wire:model='incoterm' class="form-select" disabled id="incoterms">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input disabled wire:model='date_est_shipment' wire:ignore class="form-control" id="shipment_date" type="text" placeholder="d/m/y" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row g-2">
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="port_id">Transhipment Port</label> <!-- Notes : Ambil dari Master Port Admin, Sesuaikan Type Port nya, FCL, LCL, Non Container Shipment : SEA, jika Air Freight : AIR -->
                                        <select {{ request()->user()->isAdmin() ? "" : "disabled" }} wire:model='port_id' class="form-select" id="port_id" id="port_id">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input {{ request()->user()->isAdmin() ? "" : "disabled" }} wire:model='port_printed_as' class="form-control" id="port_printed_as" type="text" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input required wire:model='containers.{{ $val }}.{{ $i }}' class="form-control" type="text" placeholder="Container" id="containers.{{ $val }}.{{ $i }}" />
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input required wire:model='seals.{{ $val }}.{{ $i }}' class="form-control" type="text" placeholder="Seal" id="seals.{{ $val }}.{{ $i }}" />
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-10">
                                        <div class="mb-3">
                                            ...
                                            <br>
                                            <a href="{{ asset("files/$file_msds[$val]") }}" class="btn btn-sm btn-primary" download>DOWNLOAD FILE MSDS</a>
                                        </div>
                                    </div>
                                    @endif
                            ...
                            <div class="card mb-3" id="goods_description.{{ $i }}">
                                <div class="card-body">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-2">
                                            <div class="mb-3">
                                                <label class="form-label" for="total-unit.{{ $val }}">Total Package Type</label>&nbsp;
                                                <span class="badge rounded-pill bg-secondary">Units</span>
                                                <input disabled wire:model='cargo_total_unit.{{ $val }}' class="form-control" type="number" min="0" placeholder="Total Unit" id="total-unit.{{ $val }}" />
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea rows="10" id="marks_numbers.{{ $val }}" wire:model='marks_numbers.{{ $val }}' class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-8">
                                            <div class="mb-3">
                                                <label class="form-label" for="goods_description">Description of Goods</label>
                                                <textarea rows="10" wire:model='goods_description' id="goods_description" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea wire:model='freight_remark' class="form-control" rows="4"></textarea>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <br>
                                <a title="download file" download="{{ $key }}.{{ pathinfo($file, PATHINFO_EXTENSION) }}" class="btn btn-sm btn-primary" href="{{ asset("files/{$file}") }}">
                                    Download {{ (isset(config('fcl-lang')[$key]) ? config('fcl-lang')[$key] : $key) }}
                                </a>
                            </div>
                        </div>
                        @endforeach                    
            ...
            <div class="row g-2">
                <div class="col-12 text-center">
                    <button class="btn btn-primary" style="width: 25%; min-width: 100px;">{{ $admin_mode ? "UPDATE SHIPPING INSTRUCTION" : "SUBMIT SHIPPING INSTRUCTION" }}</button>
                </div>
            </div>
