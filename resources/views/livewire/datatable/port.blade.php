<div>
    <div class="row mb-3">
        <div class="col-8">
            <div id="actions">
                <a class="btn btn-dark me-1 mb-1 btn-sm" href="{{ route("internal.master.port-create") }}">
            ...
            <table class="table table-bordered table-striped fs--1 mb-0">
                ...
                <tbody class="list">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div>
                                <a class="btn btn-primary me-1 mb-1 btn-sm" href="{{ route('internal.master.port-update', $item->id) }}">
                                    <span class="fas fa-edit" data-fa-transform="shrink-3 down-2"></span>
                                    <span class="d-none d-sm-inline-block ms-1">Edit</span>
                                </a>

                                <button class="btn btn-danger me-1 mb-1 btn-sm" data-delete-route="{{ route('internal.master.port-delete', $item->id) }}"
