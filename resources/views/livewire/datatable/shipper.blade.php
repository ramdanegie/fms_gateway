<div>
    <div class="row mb-3">
        <div class="col-8">
            <div id="actions">
                <a class="btn btn-dark me-1 mb-1 btn-sm" href="{{ route("master.shipper-create") }}">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div>
                                ...
                                <a class="btn btn-primary me-1 mb-1 btn-sm" href="{{ route('master.shipper-update', $item->id) }}">
                                    <span class="fas fa-edit" data-fa-transform="shrink-3 down-2"></span>
                                    <span class="d-none d-sm-inline-block ms-1">Edit</span>
                                </a>

                                <a class="btn btn-danger me-1 mb-1 btn-sm" data-delete-route="{{ route('master.shipper-delete', $item->id) }}" class="btn p-0 ms-2" type="button" data-bs-toggle="tooltip"
