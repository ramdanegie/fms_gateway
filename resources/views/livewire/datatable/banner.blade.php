            ...
            <table class="table table-bordered table-striped fs--1 mb-0">
                ...
                <tbody class="list">
                    ...
                    <tr>
                        <td>{{ $item->title }}</td>
                        <td>
                            <img src="{{ asset("files/{$item->file_banner}") }}" style="max-width: 120px">
                        </td>
                        <td>{{ Convert::dateFormat($item->created_at) }}</td>
                        <td class="text-end">
                            <div>                                
                                <a class="btn btn-primary me-1 mb-1 btn-sm" href="{{ route('internal.master.banner-update', $item->id) }}">
                                    <span class="fas fa-edit" data-fa-transform="shrink-3 down-2"></span>
                                    <span class="d-none d-sm-inline-block ms-1">Edit</span>
                                </a>

                                <button class="btn btn-danger me-1 mb-1 btn-sm" data-delete-route="{{ route('internal.master.banner-delete', $item->id) }}"
