<div>
    <div id="actions">
        <a class="btn btn-dark me-1 mb-1 btn-sm" href="{{ route("internal.master.team-create") }}">
            ...
            <table class="table table-bordered table-striped fs--1 mb-0">
                <thead class="table" style="background-color: #1E367B">
                    <tr style="color: white">
                        ...
                        <th style="width:40%">Access Title</th>
                        <th>Created At</th>
                ...
                <tbody class="list">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div>
                                <a class="btn btn-secondary me-1 mb-1 btn-sm" href="{{ route("internal.master.team-role", $item->id) }}">
                                    <span class="fas fa-users-cog" data-fa-transform="shrink-3 down-2"></span>
                                    <span class="d-none d-sm-inline-block ms-1">Set Access</span>
                                </a>

                                <a class="btn btn-primary me-1 mb-1 btn-sm" href="{{ route("internal.master.team-update", $item->id) }}">
                                    <span class="fas fa-edit" data-fa-transform="shrink-3 down-2"></span>
                                    <span class="d-none d-sm-inline-block ms-1">Edit</span>
                                </a>

                                <button class="btn btn-danger me-1 mb-1 btn-sm"  data-delete-route="{{ route("internal.master.team-delete", $item->id) }}"
