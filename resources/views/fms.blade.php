                ...
                <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="toggle-icon-wrapper">
                            ...
                            <div class="d-flex align-items-center py-3"><img class="me-2" src="{{ asset('falcon/assets/img/logo.png') }}" alt="" width="130" />
                            </div>
                        </a>
                    </div>
                            ...
                            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                                @foreach (Menus::getRoleForTeam(request()->user()->team) as $item)
                                    ...
                                    <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                        <div class="col-auto navbar-vertical-label" style="color: #1E367B; font-weight: bold; font-size: 14px">Quotation</div>
                                        <div class="col ps-0">
                                    ...
                                    @endif
                                     ...
                                     @if ($item['key'] == "MS01")
                                    <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                        <div class="col-auto navbar-vertical-label" style="color: #1E367B; font-weight: bold; font-size: 14px">Shipment
                                        </div>
                                        <div class="col ps-0">
                                            <hr class="mb-0 navbar-vertical-divider" style="border-top: 2px solid #FFF02D;"/>
                                        </div>
                                    ...
                                    @endif
                                     ...
                                     @if ($item['key'] == "DD01")
                                    <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                        <div class="col-auto navbar-vertical-label" style="color: #1E367B; font-weight: bold; font-size: 14px">Document
                                        </div>
                                        <div class="col ps-0">
                                            <hr class="mb-0 navbar-vertical-divider" style="border-top: 2px solid #FFF02D;"/>
                                        </div>
                                    ...
                                    @if ($item['key'] == "OT01")
                                    <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                        <div class="col-auto navbar-vertical-label" style="color: #1E367B; font-weight: bold; font-size: 14px">Help Center
                                        </div>
                                        <div class="col ps-0">
                                            <hr class="mb-0 navbar-vertical-divider" style="border-top: 2px solid #FFF02D;"/>
                                        </div>
                                    ...
                                    <a class="nav-link dropdown-indicator" href="#{{ $item["key"] }}" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="data-master" style="color: #2c2e30">
                                        <div class="d-flex align-items-center">
                                    ...
                                    @foreach ($item['childs'] as $child)
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ Route::has($child["route"]) ? route($child["route"], (isset($child['payload']) ? $child['payload'] : "")) : "" }}" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                    ...
                                    @else
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ Route::has($item["route"]) ? route($item["route"], (isset($child['payload']) ? $child['payload'] : "")) : "" }}" role="button" aria-expanded="false">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-icon"><span class="{{ $item["icon"] }}"></span></span>
                                                <span class="nav-link-text ps-1">{{ $item["title"] }}</span>
                                            </div>
